...
| Logística Flota visual | [brief](docs/design-system/brief-logistica-flota-visual-v0.md), [ADR-009 architecture](architecture/ADR-009-logistica-flota-ops-estado-v0.md), [ADR-011](docs/adr/011-logistica-flota-ops-estado.md). Nav → `/flota`. Assign-chofer **parked**. No tocar Mantenimiento `/unidades`. |
