...
|----------|-------------|
| Kernel, unidades, choferes, tipos, outbox | [ADR-000](docs/adr/000-thin-kernel.md), [ADR-001](docs/adr/001-visita-cerrada-outbox.md), [ADR-002](docs/adr/002-schema-per-module.md) |
...
README: multi-almacén, lotes, costeo, OC formal, kardex pesado, ítem↔placa, reserva de stock en borrador. No ampliar ownership de Inventario ni Andon sin ADR.
