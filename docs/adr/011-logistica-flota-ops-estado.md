...
Kernel `unidades.ambito`, `unidades.destino`, `unidades.ops_estado`. Registrar regreso: `EN_RUTA` → `DISPONIBLE`. Asignación chofer **parked**. Mantenimiento UI no se toca aquí.
