...
Seams (puertos): `NotifyPort`, `StockAlertPort`, `AvisoInboxPort`, `AndonAbiertoPort` (Flota lee aviso Andon abierto; sin UI Andon). IDs opacos; sin FKs/JOINs cruzadas (ADR-002).
